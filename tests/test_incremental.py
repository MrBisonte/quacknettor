...
def test_incremental_flow(tmp_path):
    ...
    config = {
        "source": {"type": "parquet", "path": src_path, "incremental_key": "updated_at"},
        "target": {"type": "parquet", "path": tgt_path, "mode": "append"},
        "options": {"compute_counts": True, "sample_data": False},
    }
